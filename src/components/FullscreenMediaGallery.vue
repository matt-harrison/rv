<script lang="ts" setup>
  ...
  const sellerNameLocation = getSellerNameLocation(vehicleData.value);
  const listingTitle = getVehicleTitle(vehicleData.value);
  const price = getVehiclePrice(vehicleData.value);
  const sellerPhoneNumber = getVehiclePhone(vehicleData.value);
  const sellerTextNumber = formatPhone(Number(vehicleData.value.phone));
  const phoneHref = getVehiclePhoneHref(vehicleData.value);
    ...
    >
      ...
      >
        ...
        <BasicButtonIcon
          :icon="ICONS.XMARK"
          @click="handleClose"
          class="tertiary ml-auto shadow-box"
          is-restyled
        />
      </header>
      <main
        ...
        >
          ...
          >
            ...
            >
              ...
              <SvgIcon
                :svg-id="slide.type === MEDIA_SLIDE_TYPES.VR ? ICONS.TOUR : ICONS.PLAY"
