  ...
  <Teleport to="body">
    <Transition>
      <div
        ...
        class="basic-modal theme-dark fixed flex axis1-center axis2-center top-0 left-0 w-full h-full"
        v-show="props.isOpen"
      >
        <div
          :style="{ ...modalStyle }"
          class="modal-body flex column border-surface radius-1/2 bg-surface font-surface xy-hidden"
        >
